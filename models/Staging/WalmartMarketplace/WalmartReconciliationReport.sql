...
dedup as (
select *,
DENSE_RANK() OVER (PARTITION BY Walmart_dot_com_PO__hash, Walmart_dot_com_P_dot_O_dot__Line__hash,Transaction_Type,Adjustment_Code order by _daton_batch_runtime desc) row_num

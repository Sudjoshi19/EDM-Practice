...
coalesce(ChannelProductId,'') product_id,
coalesce(ItemSKUCode,'') sku,
coalesce(ItemTypeName,'') product_name,
coalesce(ItemTypeColor,'') color,
coalesce(ItemTypeBrand,'') seller,
coalesce(ItemTypeSize,'') size,
